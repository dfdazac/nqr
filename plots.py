    ...
    for ax, title, metric_idx in zip(axes, titles, range(len(titles))):
        ...
        for method_idx, (metrics, method_name, color) in enumerate(zip(metrics_all_methods, method_names, itertools.cycle(colors))):
            ...
            if method_name == "Unconstrained":
                # For Unconstrained, show horizontal line with confidence interval as a shaded band
...
# TARGET MODE PLOTS (4 methods: Unconstrained, MeanCosine, NQR, SCORE)

# FB15K237 - Target Mode
plot_metrics_comparison(OrderedDict([
    ("Unconstrained", "results/fb15k237-betae_10_0.0002_default_test_mixed_target_1757178216_rq8chcd6"),
...
plot_metrics_comparison(OrderedDict([
    ("Unconstrained", "results/hetionet_10_0.001_default_test_mixed_target_1757178246_dxkau1zu"),
...
# NELL995 - Target Mode
plot_metrics_comparison(OrderedDict([
    ("Unconstrained", "results/nell-betae_10_0.0002_default_test_mixed_target_1757178211_0pf4oo3l"),
...
# FULL MODE PLOTS (2 methods: Unconstrained, SCORE)

# FB15K237 - Full Mode
plot_metrics_comparison(OrderedDict([
    ("Unconstrained", "results/fb15k237-betae_10_0.0002_default_test_mixed_full_1757178217_q1f9v156"),
...
# HETIONET - Full Mode
plot_metrics_comparison(OrderedDict([
    ("Unconstrained", "results/hetionet_10_0.001_default_test_mixed_full_1757178247_2vbjrw1k"),
...
# NELL995 - Full Mode
plot_metrics_comparison(OrderedDict([
    ("Unconstrained", "results/nell-betae_10_0.0002_default_test_mixed_full_1757178218_9jqnj61o"),
